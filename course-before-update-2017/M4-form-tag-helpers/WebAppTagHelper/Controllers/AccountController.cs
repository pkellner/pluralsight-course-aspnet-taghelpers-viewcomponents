...
using WebAppTagHelper.Models.AccountViewModels;
using WebAppTagHelper.Services;
...
namespace WebAppTagHelper.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> RegisterTH(RegisterViewModel model, string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
